...
/*
    ...
    -> 컬럼을 직접 제시하여 해당 컬럼에 대한 값만을 추가
        ...
        => NOT NULL 제약 조건이 있는 컬럼의 경우 직접 컬럼을 제시하여 값을 추가하거나
...
-- ASIA지역에서 근무중인 사원들의 보너스값을 0.3으로 변경
-- * ASIA지역 정보조회
SELECT *
FROM LOCATION
...
WHERE DEPT_ID = 'D1';
--> D1값을 EMPLOYEE테이블 사용 중이기 때문에 삭제 불가 (외래키 설정되어 있음!)
