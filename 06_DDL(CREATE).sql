...
-- 테이블에 데이터 추가하기 (DML): INSERT INTO 테이블명 VALUES(값, 값, 값, ....)
INSERT INTO MEMBER VALUES(1,'DOOL6137', '1234', '김정현', '여', '010-1234-1234', 'DOOL6137@NAVER.COM', '24/7/24');
...
--회원번호, 아이디, 비밀번호, 이름에 대한 데이터는 NULL값을 저장하지 않겠다!
...
--> 설정한 대로 회원아이디 부분에 데이터가 NULL값이라서 오류가 발생! (제약조건에 위배됨)
INSERT INTO MEMBER_NOTNULL
    VALUES (1, 'DAWUN', '1234', '기다운', '남', '010-1234-1234', 'DAWUNI@GMAIL.COM', SYSDATE);
...
INSERT INTO MEMBER_UNIQUE
    VALUES(2, 'QWER', '1111', 'QWER', '여', NULL, NULL, NULL);
